...
public class TodoListController {
    ...
    public ResponseEntity addTodoItem(@RequestParam final String todoItem) throws ExecutionException, InterruptedException {
    ...
    public ResponseEntity deleteTodoItem(@RequestParam final String todoItem) throws ExecutionException, InterruptedException {
